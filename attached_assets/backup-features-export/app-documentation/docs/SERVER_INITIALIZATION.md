...
## Configuration Options The initialization process is controlled by various configuration options: ### Feature Toggles - `config.features.enableWebSockets`: Enable/disable WebSocket serve
