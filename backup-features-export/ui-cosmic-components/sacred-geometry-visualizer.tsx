...
const geometryInfo = {
  flowerOfLife: {
    ...
    description:
      "A sacred geometric pattern composed of multiple evenly-spaced, overlapping circles arranged in a flower-like pattern. It contains the blueprint of creation and is found in ancient cultures worldwide.",
    effect:
      "Harmonizes the electromagnetic field of the body, activates the pineal gland, and promotes cellular regeneration.",
    icon: Flower,
  },
  metatronsCube: {
    title: "Metatron's Cube",
    description:
      "A complex sacred geometry figure composed of 13 circles with lines connecting the centers. It contains all 5 Platonic solids, representing the building blocks of the universe.",
    effect:
      "Balances energy, protects against negative influences, and enhances spiritual awareness and connection to higher realms.",
    icon: Hexagon,
  },
  merkaba: {
    title: "Merkaba",
    description:
      "A three-dimensional 8-pointed star formed from two interlocked tetrahedra, one pointing up and one pointing down. The word 'Merkaba' means light-spirit-body in Hebrew.",
    effect:
      "Activates the light body, facilitates interdimensional travel, and accelerates spiritual evolution and ascension.",
    icon: Star,
  },
  sriYantra: {
    title: "Sri Yantra",
    description:
      "A complex mandala formed by nine interlocking triangles that surround a central point (bindu), creating 43 triangles total. It represents the cosmos and the body of the goddess.",
    effect:
      "Enhances concentration, manifestation abilities, and spiritual connection; balances masculine and feminine energies.",
    icon: Infinity,
  },
  fibonacciSpiral: {
    title: "Fibonacci Spiral",
    description:
      "A pattern that follows the Fibonacci sequence, where each number is the sum of the two preceding ones. It creates a logarithmic spiral found throughout nature.",
    effect:
      "Aligns one with natural growth patterns, enhances creativity, and promotes harmony with universal order.",
    icon: Circle,
  },
  torus: {
    title: "Torus",
    description:
      "A donut-shaped geometry that represents the fundamental energy pattern of all matter, from atoms to galaxies. Energy flows in and out through the center in a continuous self-sustaining pattern.",
    effect:
      "Activates the heart field, enhances energy circulation, and facilitates connection with universal consciousness.",
    icon: Circle,
  },
  vesicaPiscis: {
    title: "Vesica Piscis",
    description:
      "Formed by the intersection of two circles with the same radius, where each circle's center lies on the other's circumference. It symbolizes the union of dualities.",
    effect:
      "Balances hemispheres of the brain, harmonizes polarities, and opens gateways to higher dimensions.",
    icon: Circle,
  },
  pentagram: {
    title: "Pentagram",
    description:
      "A five-pointed star that embodies the golden ratio φ (phi) and represents the five elements. It has been a sacred symbol in many traditions.",
    effect:
      "Provides protection, balance of elements, and enhanced connection to natural cycles and wisdom.",
    icon: Star,
  },
  platonic: {
    title: "Platonic Solids",
    description:
      "The five three-dimensional regular polyhedra: tetrahedron, cube, octahedron, dodecahedron, and icosahedron. Named after Plato, who associated them with the classical elements.",
    effect:
      "Each solid resonates with different energy centers and elements, providing balance, stability, and alignment with cosmic principles.",
    icon: Hexagon,
  },
};
...
export function SacredGeometryVisualizer() {
  ...
  const [activePattern, setActivePattern] =
    useState<GeometryPattern>("flowerOfLife");
  ...
  useEffect(() => {
    ...
    switch (activePattern) {
      ...
      case "merkaba":
        ...
        const tetraUp = new THREE.TetrahedronGeometry(
          patternSize / 2,
          detailLevel,
        );
        const tetraDown = new THREE.TetrahedronGeometry(
          patternSize / 2,
          detailLevel,
        );
      ...
      case "fibonacciSpiral":
        ...
        for (let i = 0; i < 1000 * detailLevel; i++) {
          const theta = 0.1 * i;
          const spiralRadius =
            0.1 * Math.pow(goldenRatio, theta / (2 * Math.PI));
      ...
      case "platonic":
        ...
        // Tetrahedron
        const tetraGeom = new THREE.TetrahedronGeometry(
          patternSize / 6,
          detailLevel,
        );
        ...
        // Octahedron
        const octaGeom = new THREE.OctahedronGeometry(
          patternSize / 5,
          detailLevel,
        );
        ...
        // Dodecahedron
        const dodecaGeom = new THREE.DodecahedronGeometry(
          patternSize / 4,
          detailLevel,
        );
        ...
        // Icosahedron
        const icosaGeom = new THREE.IcosahedronGeometry(
          patternSize / 5,
          detailLevel,
        );
        const icosaMat = new THREE.MeshStandardMaterial({
          color:
            colorSchemes[colorScheme][4 % colorSchemes[colorScheme].length],
          wireframe: true,
        });
      ...
      case "sriYantra":
        ...
        for (let i = 0; i < triangleCount; i++) {
          ...
          const triangleMat = new THREE.LineBasicMaterial({
            color:
              colorSchemes[colorScheme][i % colorSchemes[colorScheme].length],
            linewidth: 2,
          });
      ...
      case "vesicaPiscis":
        ...
        const circle1Geo = new THREE.BufferGeometry().setFromPoints(
          circlePoints,
        );
        ...
        const circle2Geo = new THREE.BufferGeometry().setFromPoints(
          circlePoints,
        );
  ...
  // Active tab info
  const currentGeometryInfo = useMemo(
    () => geometryInfo[activePattern],
    [activePattern],
  );
  ...
  const renderPatternSelectionMenu = () => (
    <Tabs defaultValue="flower" className="w-full">
      <TabsList className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-1 mb-4 bg-cosmic-dark/50 rounded-lg backdrop-blur-md p-1">
        <TabsTrigger
          value="flower"
          onClick={() => handlePatternChange("flowerOfLife")}
          className="rounded-md font-michroma"
        >
        ...
        <TabsTrigger
          value="metatron"
          onClick={() => handlePatternChange("metatronsCube")}
          className="rounded-md font-michroma"
        >
        ...
        <TabsTrigger
          value="merkaba"
          onClick={() => handlePatternChange("merkaba")}
          className="rounded-md font-michroma"
        >
        ...
        <TabsTrigger
          value="yantra"
          onClick={() => handlePatternChange("sriYantra")}
          className="rounded-md font-michroma"
        >
        ...
        <TabsTrigger
          value="spiral"
          onClick={() => handlePatternChange("fibonacciSpiral")}
          className="rounded-md font-michroma"
        >
        ...
        <TabsTrigger
          value="torus"
          onClick={() => handlePatternChange("torus")}
          className="rounded-md font-michroma"
        >
          <Circle className="h-4 w-4 mr-1" />
        ...
        <TabsTrigger
          value="vesica"
          onClick={() => handlePatternChange("vesicaPiscis")}
          className="rounded-md font-michroma"
        >
          <Circle className="h-4 w-4 mr-1" />
        ...
        <TabsTrigger
          value="pentagram"
          onClick={() => handlePatternChange("pentagram")}
          className="rounded-md font-michroma"
        >
          <Star className="h-4 w-4 mr-1" />
        ...
        <TabsTrigger
          value="platonic"
          onClick={() => handlePatternChange("platonic")}
          className="rounded-md font-michroma"
        >
          <Hexagon className="h-4 w-4 mr-1" />
        ...
        >
          <div className="flex justify-between items-start mb-2">
            <h3 className="text-lg font-semibold font-orbitron flex items-center">
              {currentGeometryInfo.icon && (
                <currentGeometryInfo.icon className="mr-2 h-5 w-5" />
              )}
          ...
          <p className="text-sm mb-2">{currentGeometryInfo.description}</p>
          <p className="text-sm text-cosmic-primary">
            <strong className="text-cosmic-highlight">Effect:</strong>{" "}
            {currentGeometryInfo.effect}
          </p>
        </motion.div>
      )}
    </AnimatePresence>
