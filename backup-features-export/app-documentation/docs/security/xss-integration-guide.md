# XSS Prevention Integration Guid
...
## Client-Side Integration ### React Components Integration Import and use the XSS prevention components in your React applicatio
