      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-6">
            <p className="text-[#e8e6e3]/50 text-sm">&copy; {new Date().getFullYear()}Language Copyright claimed                 by Ronald Lee Swan 2025</p>
             <p className="text-[#e8e6e3]/50 text-sm">&copy; {new Date().getFullYear()} Website-App Copyright                     claimed by Ronald Lee Swan 2025</p>
